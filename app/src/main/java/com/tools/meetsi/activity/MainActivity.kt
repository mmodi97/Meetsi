package com.tools.meetsi.activity
...
import com.tools.meetsi.adapteritem.DemoFragmentStateAdapter


import com.tools.meetsi.databinding.ActivityMainBinding
import com.tools.meetsi.sharedpref.AppPref
import com.tools.meetsi.sharedpref.SharedPrefData
 ...
 */
    ...
    private fun setProfileIcon() {
        sharedPrefData= SharedPrefData(this)
        Log.d("woqhyroiu", sharedPrefData!!.getAuthId().toString())
        binding.ivProfile.load(sharedPrefData!!.getImage())
        Log.d("wdqdj", sharedPrefData!!.getSkip().toString())
...
/*
    ...
    */
    private fun onProfileClick() {
        sharedPrefData= SharedPrefData(this)
        Log.d("joqwhfdo", sharedPrefData!!.getEmail().toString())
        ...
        binding.ivProfile.setOnClickListener {
            ...
            profileDialog.apply {
                ...
                Log.d("bottomSheetLog", sharedPrefData!!.getSkip().toString())
                if(sharedPrefData!!.getSkip().equals("Skip"))
                {
                ...
                else
                {
                    ...
                    requestOptions.diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
                    requestOptions.centerCrop()
                    Log.d("weojhfo", sharedPrefData!!.getAuthId().toString())
